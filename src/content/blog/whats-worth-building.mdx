...
heroImage: "/blog/whats-worth-building/hero.png"
...
<div className="flex flex-row gap-2">
  <Tag text="Fairness" style="bg-candlelight-peach text-ash dark:bg-candlelight-peach/10 dark:text-candlelight-peach border-candlelight-peach" />
...
<div className="flex flex-row gap-2">
  <Tag text="Positive impact" style="bg-creamy-avocado text-ash dark:bg-creamy-avocado/10 dark:text-creamy-avocado border-creamy-avocado" />
  <Tag text="Pride" style="bg-sasquatch-socks text-white dark:bg-sasquatch-socks/10 dark:text-sasquatch-socks border-sasquatch-socks" />
</div>
...
![An illustration of a compass shining light on a terrain](/blog/whats-worth-building/intermission-01.png)
