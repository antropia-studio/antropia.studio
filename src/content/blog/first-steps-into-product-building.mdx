...
description: "We're building our own products. Here's where we're starting: five domains, early ideas, and ramblings while figuring out what's worth pursuing."
...
<div className="flex flex-row gap-2">
  <Tag text="Pride" style="bg-sasquatch-socks text-white dark:bg-sasquatch-socks/10 dark:text-sasquatch-socks border-sasquatch-socks" />
  <Tag text="Satisfaction" style="bg-hello-summer text-ash dark:bg-hello-summer/10 dark:text-hello-summer border-hello-summer" />
  <Tag text="Organicity" style="bg-benzol-green text-ash dark:bg-benzol-green/10 dark:text-benzol-green border-benzol-green" />
</div>
...
I split each idea into multiple sections for better scannability:
...
![An illustration of a dog](/blog/first-steps-into-product-building/dog-idea.png)
...
![An illustration of a cup of coffee and a laptop](/blog/first-steps-into-product-building/freelancing-idea.png)
...
![An illustration of a seven eleven](/blog/first-steps-into-product-building/small-business-idea.png)
...
![An illustration of a multitude of people talking or screaming at each other](/blog/first-steps-into-product-building/social-network-idea.png)
...
![An illustration of some colorful server racks](/blog/first-steps-into-product-building/self-hosted-idea.png)
